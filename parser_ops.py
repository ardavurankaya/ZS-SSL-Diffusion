...
def get_parser():
    ...
    parser.add_argument('--kdata_dir', type=str, default='data_directory/data_name.mat',
                    help='data directory') 
    parser.add_argument('--sensdata_dir', type=str, default='data_directory/data_name.mat',
                    help='data directory') 
    parser.add_argument('--maskdata_dir', type=str, default='data_directory/data_name.mat',
                    help='data directory')              
    parser.add_argument('--ref_image', type=str)
    parser.add_argument('--nrow_GLOB', type=int, default=220,
                        help='number of rows of the slices in the dataset')
    parser.add_argument('--ncol_GLOB', type=int, default=220,
